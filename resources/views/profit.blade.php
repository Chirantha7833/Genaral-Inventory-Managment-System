...
<div class="mx-auto p-2 text-center">
    <h1 class="font-bold text-[40px] m-2">Reports-Profit</h1>
</div>
<div class="flex">
    ...
    <div>
    <table border="1" class="mx-5">
        <thead>
            <tr class="m-2 bg-slate-900">
                <th class="font-bold text-center p-2 text-amber-400">Date</th>
                <th class="font-bold text-center p-2 text-amber-400">Customer ID</th>
                <th class="font-bold text-center p-2 text-amber-400">Customer Name</th>                               
                ...
                <th class="font-bold text-center p-2 text-amber-400">Profit</th>
        ...
        <tbody>
            @foreach($data as $item)
                <tr class="m-2 bg-slate-900">
                    ...
                    <td class="p-2">{{ $item->customer_id }}</td>
