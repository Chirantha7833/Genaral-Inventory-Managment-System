...
<div class="flex">
    <div class="my-auto">
    <h1 class="text-[50px] font-bold m-2">Register <br> Customers</h1>
    <a href="/registerdcustomers" class="m-2">View List</a>
    </div>

<form action="{{ url('/registercustomers') }}" method="post" class="bg-black rounded-[20px] h-[580px] w-[500px] text-center mx-auto mt-5">
        @csrf 
        <div class="flex">
        <div class="flex flex-col ml-10">
                <label for="name" class="mt-10 p-2">Customer Name</label> 
